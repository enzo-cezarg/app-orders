unit rr4dl.Request.NetHTTP;

interface

uses System.Net.Mime, System.Net.HttpClientComponent, System.Net.HttpClient,
  rr4dl.Request.Contract, System.Classes, Data.DB, System.JSON, System.SysUtils,
  IdURI, System.NetEncoding, rr4dl.Response.NetHTTP, rr4dl.Response.Contract,
  System.Net.URLClient, j4dl;
...
type
  ...
  private
    ...
    function AddBody(const AContent: TJSONObject; const AOwns: Boolean = False): IRequest; overload;
    function AddBody(const AContent: TJSONArray; const AOwns: Boolean = False): IRequest; overload;
...
begin
  Result := Self.AddBody(AContent.Stringify);
  if AOwns then
    AContent.Free;;
end;
