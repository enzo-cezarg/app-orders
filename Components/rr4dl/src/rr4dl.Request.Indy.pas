...
uses rr4dl.Request.Contract, j4dl, rr4dl.Response.Contract,
    IdHTTP, IdSSLOpenSSL, IdCTypes, IdSSLOpenSSLHeaders,
  {$IFDEF FPC}
    DB, Classes, SysUtils;
  {$ELSE}
...
uses rr4dl.Response.Indy, IdURI, IdCookieManager;
